...
export const TRANSLATIONS = {
  "English": {
    ...
    "opsFlow": "Brand → SEO → Campaigns → Strategy → Create → Approve → Publish",
  ...
  "Hindi": {
    ...
    "campaigns": "4. अभियान (Campaigns)",
    "strategy": "5. रणनीति (Strategy)",
  ...
  "Bengali": {
    ...
    "campaigns": "4. ক্যাম্পেইন (Campaigns)",
    "strategy": "5. কৌশল (Strategy)",
  ...
  "Marathi": {
    ...
    "campaigns": "4. मोहिमा (Campaigns)",
    "strategy": "5. रणनीती (Strategy)",
  ...
  "Telugu": {
    ...
    "campaigns": "4. ప్రచారాలు (Campaigns)",
    "strategy": "5. వ్యూహం (Strategy)",
  ...
  "Spanish": {
    ...
    "campaigns": "4. Campañas",
    "strategy": "5. Estrategia",
  ...
  "German": {
    ...
    "campaigns": "4. Kampagnen",
    "strategy": "5. Strategie",
    "calendar": "6. Kalender",

...
export const Header = () => {
  ...
  return (
    <header className="h-16 shadow-[0_4px_20px_rgba(0,0,0,0.02)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.3)] bg-white/70 dark:bg-[#070b19]/80 backdrop-blur-xl border-b border-purple-100/50 dark:border-slate-800/60 sticky top-0 z-30 transition-colors w-full overflow-x-clip relative">

        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-6 items-center justify-center">
          {brandPlaceholders.map((brand, idx) => {
            ...
            return (
              <div 
                key={idx}
                className="flex items-center justify-center gap-2.5 px-4 py-3.5 rounded-2xl bg-slate-950/60 border border-slate-800/80 text-slate-400 hover:text-white hover:border-slate-700 transition-all cursor-default group"
              >
                <IconComp className="w-5 h-5 text-indigo-400 group-hover:text-indigo-300 transition-colors" />
